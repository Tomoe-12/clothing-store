                ...
                <div class='w-full flex flex-col gap-4 mt-5'>
                    ...
                    <a href="../home.php"
                        ...
                        <a href="./ordered.php"
                            ...
                            <svg class='w-7 h-7' viewBox="0 0 24.00 24.00" fill="none"
                                xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1.128">
 ...
 if($row=$result->fetch_assoc()){?>
                <form action="../../function/adminnotiupdate.php" method="post" id="submit"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input style="display:none" type="text" value="<?php echo $_GET["noti"] ?>" name="noti">
