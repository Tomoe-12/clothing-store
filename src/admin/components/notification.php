                            ...
                            <form action="./delete.php" method="post">
                                ...
                                <button type='submit' class='w-6 h-6'>
                                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path d="M10 11V17" stroke="#FF4F4E" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M14 11V17" stroke="#FF4F4E" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M4 7H20" stroke="#FF4F4E" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path
