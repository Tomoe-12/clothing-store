...
<head>
    ...
    <link rel="stylesheet" href="./src/css/home3.css">
    <link rel="stylesheet" href="./src/css/home4.css">
...
if(!empty($result)&& $result->num_rows>0){
 ...
 <img src="data:image/jepg;base64,<?php echo base64_encode($row["per_img"]) ?>" alt="" style="max-height:200px;border-radius:50%;" >
        ...
        if(!empty($result)&& $result->num_rows>0){
           while($row=$result->fetch_assoc()){ ?>
               ...
               <td style="padding: 0px;margin:0px"> <img  src="data:image/jepg;base64,<?php echo base64_encode($row["image"]) ?>" alt="" style="height:50px;width:70px;" >
                ...
                <td class="action" style="width:5%;padding:8px; border-radius:8px ;background-color:red;"><form  action="../pages/home.php" method="get">
...
<a  href="../pages/home.php"><div class="cat">All</div></a>
<a  href="../pages/Men.php"> <div class="cat">Men's Collections</div></a>
<a href="../pages/Lady.php"><div class="cat">Lady's Collections</div></a>
</div>
...
<div class="price"> <div class="div1"><?php echo $row["price"] ?>KS</div> <a href="./Detail.php?item_id=<?php  echo $row["clo_id"]; ?>"><div class="div2">View Details</div></a> </div>
