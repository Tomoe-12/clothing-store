    ...
    <div class="heading">
        ...
        <div class="searchbar">
            <form action="./search.php" method="get">
                <input type="text" name="val" placeholder="Type of clothe"><input type="submit" value="Search"
                    name="search">
            </form>
        </div>
        <div class="options">
    ...
    while($row=$result->fetch_assoc()){ 
       ...
       ?>
            <div class="item"><img src="data:image/jepg;base64,<?php echo base64_encode($row["image"]) ?>" alt="">
                <div class="price">
                    <div class="div1"><?php echo $row["price"] ?>KS</div> <a
                        href="./Detail.php?item_id=<?php  echo $row["clo_id"]; ?>">
                        <div class="div2">View Details</div>
                    </a>
                </div>
