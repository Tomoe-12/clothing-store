...
<body>
            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 shadow-md' : 'opacity-0 -translate-x-full']"
                    ...
                    <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                        ...
                        <a href="#"
                            class="px-3 py-2 mx-3 mt-2 text-primary font-semibold transition-colors duration-300 transform rounded-md lg:mt-0  hover:bg-gray-100 ">Men's
                        </a>
                        <a href="./Lady.php"
   ...
   $result=$con->query("SELECT * FROM closet where gender='male' or gender='unisex' order by arrDate desc");
   if(!empty($result)&& $result->num_rows>0){
            ...
            <div
                ...
                <div class="mt-4 px-5 pb-5">
                    ...
                    <a href="../components/Detail.php?item_id=<?php  echo $row["clo_id"]; ?>"
                        class="flex items-center justify-center rounded-md bg-primary  px-5 py-2.5 text-center text-sm font-medium text-white btn-hover border border-primary focus:outline-none focus:ring-4 focus:ring-blue-300">
